  ...
  return (
    <div className="grid md:grid-cols-2 gap-10 items-center">
      ...
      <motion.div
        ...
        className="relative rounded-3xl p-8 shadow-2xl ring-1 ring-white/10 bg-white/5"
        style={{
      ...
      >
        ...
        <div className="relative z-[1]">
          ...
          <p className="mt-4 text-zinc-300">
            I build modern, accessible web apps and teach people how to do the
            same. I care about clean UX, solid architecture, and shipping fast.
          </p>
        ...
        <span
          ...
          style={{
            boxShadow: "0 0 120px rgba(99,102,241,.25)",
          }}
        />
      </motion.div>

      {/* RIGHT: portrait (with tilt glow) */}
      <HeroPortrait />
    </div>
  );
}
